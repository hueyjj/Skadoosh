...
export const newCMPSModel = () => {
  ...
  let nodeCmpe107 = new DefaultNodeModel("CMPE 107 or AMS 131", "rgb(192,255,0)");
  ...
  let nodeElectiveDc = new DefaultNodeModel("Upper Division ELECTIVE (DC)", "rgb(192,255,0)");
  let portElectiveDc = nodeElectiveDc.addInPort("CMPS 115, 132W, 180W, 185, 195 or CMPE 185.");
  nodeElectiveDc.setPosition(50, 1000);

  let nodeElectiveCapstone = new DefaultNodeModel("Upper Division ELECTIVE (Capstone)", "rgb(192,255,0)");
  ...
  let nodeElectiveCmps = new DefaultNodeModel("Upper Division ELECTIVE (CMPS ELECTIVE)", "rgb(192,255,0)");
  ...
  let nodeElectiveAdditional1 = new DefaultNodeModel("Upper Division ADDITIONAL ELECTIVE)", "rgb(192,255,0)");
  let portElectiveAdditional1 = nodeElectiveAdditional1.addInPort("...");
  nodeElectiveAdditional1.setPosition(800, 1000);

  let nodeElectiveAdditional2 = new DefaultNodeModel("Upper Division ADDITIONAL ELECTIVE)", "rgb(192,255,0)");
